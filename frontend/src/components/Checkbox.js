...
export default function Checkbox({ name, value, onChange, className, checked = false, color = "var(--secondary)" }) {
  ...
  return (
    <label htmlFor={id} className={labelClasses}>
      ...
      <span
        ...
        style={{
          backgroundColor: isChecked ? color : "var(--white)",
          borderColor: color,
        }}
      >
